...
function ajax_get_monitor_tables() {
    ...
    foreach ($active_rates as $rate_post) {
        ...
        if ($from_coin && $to_coin) {
            ...
            $winner = '-';
            if ($best_market_rate > 0) {
                if ($market_rates['ChangeNOW'] == $best_market_rate) $winner = 'ChangeNOW';
                elseif ($market_rates['SimpleSwap'] == $best_market_rate) $winner = 'SimpleSwap';
                elseif ($market_rates['StealthEX'] == $best_market_rate) $winner = 'StealthEX';
            }
            ...
            $pairs_data[] = [
                ...
                'winner' => $winner, // Добавили победителя
                'client' => $client_rate,
                'is_card' => $is_card
            ];
        }
    ...
    <table class="live-rates-table" style="width: 100%;">
        <thead>
            <tr style="background: #e0f7fa;">
                <th>Пара</th>
                <th>Лучший Рыночный (Без наценки)</th>
                <th>Биржа-победитель</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $p['best'] > 0 ? $p['best'] : '-'; ?></td>
